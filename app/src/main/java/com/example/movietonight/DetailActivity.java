...
public class DetailActivity extends YouTubeBaseActivity {
    ...
    public void playVideo(final String videoId, YouTubePlayerView youTubePlayerView) {
        ...
        youTubePlayerView.initialize("AIzaSyDkn36Kv_rhhj5VD765-HGo8y4_QGMn9S4",
    ...
    public class YoutubeAsyncTask extends AsyncTask<String, Void, Youtube[]> {
        ...
        protected Youtube[] doInBackground(String... strings) {
            ...
            Request request = new Request.Builder()
                    .url("https://api.themoviedb.org/3/movie/"+m_id+"/videos?api_key=a652ee13e08fed970ce6ddfc717f595b")
                    .build();
            try {
