...
public class DetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        map.put(53,"스릴러 ");map.put(80,"범죄 ");map.put(99,"다큐멘터리 ");map.put(878,"SF ");map.put(10402,"음악 ");map.put(10749,"로맨스 ");map.put(10751,"가족 ");map.put(10752,"전쟁 ");map.put(10770,"TV Movie ");
